...
lazy val `ts-reaktive-marshal-scala` = project.settings(projectSettings: _*).dependsOn(`ts-reaktive-marshal`, `ts-reaktive-testkit` % "test", `ts-reaktive-marshal-akka` % "test")
